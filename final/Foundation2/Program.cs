...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product product2 = new Product("Banana","23412412412",100,2);
        ...
        Console.WriteLine("---------------------------------");
        Product product3 = new Product("Maznas","23412412412",30,3);
        Product product4 = new Product("Maznas","23412412412",200,2);
